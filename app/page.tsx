        ...
        <div className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
          ...
          >
            ...
            <p className="max-w-[600px] text-zinc-400 md:text-xl mt-4">
               "Xin chào, mình là Quyen! Mình đặc biệt yêu thích khám phá công nghệ, chơi các tựa game như TFT, Liên Quân và đang học tại Đại học Sun Moon."
            </p>
            <div className="flex flex-wrap justify-center gap-3 mt-6" data-aos="fade-up" data-aos-delay="100">
              <SocialButton href="https://github.com/maihongquyen" icon={<Github />} label="GitHub" />
              <SocialButton href="https://www.facebook.com/quyen.2867" icon={<Facebook />} label="Facebook" />
              <SocialButton href="https://www.youtube.com/@CôngMai-k6d" icon={<Youtube />} label="YouTube" />
              <SocialButton href="https://t.me/mquyen" icon={<Send />} label="Telegram" />
              <SocialButton href="https://t.me/+NySjt-S7V51iNWNl" icon={<Send />} label="TELE" />
              <SocialButton href="https://discord.gg/u2dapY4w" icon={<DiscordIcon />} label="Discord" />
            </div>

            <div className="flex flex-wrap justify-center gap-3 mt-2" data-aos="fade-up" data-aos-delay="200">
              <WebsiteButton href="https://locket-gold-unlocker.vercel.app/" label="LOCKET GOLD" />
              <WebsiteButton href="https://maihongquyen.github.io/quyen1223/" label="NHẠC" />
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-10 items-center">
              <div className="w-full md:w-1/2" data-aos="fade-right">
                ...
                <div className="space-y-4 text-zinc-300">
                  <p>Hi, I'm Quyền! I was born on June 28, 2007, and I'm from Thái Bình, Vietnam.</p>
                  <p>
          ...
          <div className="container px-4 md:px-6 mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <SocialCard
                ...
                url="https://www.facebook.com/quyen.2867"
                delay={300}
              />
              ...
              <SocialCard
                ...
                icon={<Send className="h-8 w-8" />}
                url="https://t.me/+NySjt-S7V51iNWNl"
                delay={500}
              />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              <SocialCard
                ...
                url="https://locket-gold-unlocker.vercel.app/"
                delay={700}
              />
              ...
              <SocialCard
                ...
                url="https://maihongquyen.github.io/quyen1223/"
                delay={800}
              />
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-4 md:mb-0">
                <h3 className="text-xl font-bold text-violet-400">Mai Hồng Quyền</h3>
                <p className="text-zinc-400">© {new Date().getFullYear()} - All rights reserved</p>
              </div>

              <div className="flex space-x-4">
                <Link
                  href="https://github.com/maihongquyen"
                  className="text-zinc-400 hover:text-violet-400 transition-colors"
                >
                  <Github className="h-5 w-5" />
                </Link>
                <Link
                  href="https://www.facebook.com/quyen.2867/"
                  className="text-zinc-400 hover:text-violet-400 transition-colors"
                >
                  <Facebook className="h-5 w-5" />
                </Link>
                <Link
                  href="https://www.youtube.com/@CôngMai-k6d"
                  className="text-zinc-400 hover:text-violet-400 transition-colors"
                >
                  <Youtube className="h-5 w-5" />
                </Link>
                <Link href="https://t.me/mquyen" className="text-zinc-400 hover:text-violet-400 transition-colors">
                  <Send className="h-5 w-5" />
                </Link>
                <Link
                  href="https://discord.gg/u2dapY4w"
                  className="text-zinc-400 hover:text-violet-400 transition-colors"
                >
